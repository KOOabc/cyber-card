...
1. **安装书签工具**：
   访问 https://cyber-card.pages.dev/gmail-bookmarklet.html
...
1. ✅ 访问：https://cyber-card.pages.dev/gmail-bookmarklet.html
2. ✅ 拖动"提取Gmail数据"按钮到书签栏
3. ✅ 登录 Gmail，搜索 `赛博名片提交`
4. ✅ 点击书签栏的按钮，自动下载 CSV
5. ✅ 完成！用 Excel 打开查看数据
